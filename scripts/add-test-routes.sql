...
FROM (
  VALUES
    ...
    ('Indira Gandhi International Airport', 'Chhatrapati Shivaji International Airport', 1400, 1200, 15000, true),
    ...
    ('Indira Gandhi International Airport', 'Kempegowda International Airport', 2150, 1800, 22000, true),
    ('Delhi Railway Station', 'Bangalore City Railway Station', 2120, 1860, 18000, false),
    
    -- Mumbai to Bangalore routes
    ('Chhatrapati Shivaji International Airport', 'Kempegowda International Airport', 980, 840, 10000, true),
    ('Mumbai Central Railway Station', 'Electronic City', 990, 900, 9500, false),
    
    -- Delhi to Jaipur routes
    ('Indira Gandhi International Airport', 'Jaipur International Airport', 270, 300, 3500, true),
    ('Delhi Railway Station', 'Jaipur Railway Station', 280, 330, 3000, true),
    
    -- Mumbai to Pune routes
    ('Chhatrapati Shivaji International Airport', 'Pune Airport', 150, 180, 2500, true),
    ...
    ('Indira Gandhi International Airport', 'Gurgaon', 25, 35, 800, true),
    ('Delhi Railway Station', 'Gurgaon', 30, 45, 700, false),
    
    -- Bangalore to Chennai routes
    ('Kempegowda International Airport', 'Chennai International Airport', 350, 360, 4500, true),
    ('Bangalore City Railway Station', 'Chennai Central Railway Station', 345, 390, 3800, false),
    
    -- Mumbai to Goa routes
    ('Chhatrapati Shivaji International Airport', 'Goa International Airport', 450, 480, 5500, true),
    ('Mumbai Central Railway Station', 'Madgaon Railway Station', 460, 540, 4800, false),
    
    -- Delhi to Agra routes (if Agra locations exist)
    ('Delhi Railway Station', 'Delhi Railway Station', 0, 0, 0, false) -- Dummy entry, remove this
) AS route_data(origin_name, destination_name, distance_km, duration_minutes, base_price, is_popular)
