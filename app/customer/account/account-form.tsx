    ...
    const fetchPreferences = async () => {
      ...
      if (prefs) {
        setNotificationPreferences({
          email_booking_updates: prefs.email_booking_updates ?? true,
          email_payment_alerts: prefs.email_payment_alerts ?? true,
          email_security_alerts: prefs.email_security_alerts ?? true,
          email_system_updates: prefs.email_system_updates ?? true,
        })
      }
    }
    fetchPreferences()
          ...
          <CardContent>
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={notificationPreferences.email_booking_updates}
                  onCheckedChange={async (checked) => {
                    setNotificationPreferences(prev => ({
                      ...prev,
                      email_booking_updates: checked
                    }))
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={notificationPreferences.email_payment_alerts}
                  onCheckedChange={async (checked) => {
                    setNotificationPreferences(prev => ({
                      ...prev,
                      email_payment_alerts: checked
                    }))
                    setSavingNotifications(true)
                    try {
                      const result = await updateNotificationPreferences(user.id, {
